...
{//Если логин и пароль были введены сохраняем их в переменных
    ...
    if(mysqli_num_rows($check_admin) > 0){//Если логины совпали идет проверка пароля на совпадение
        ...
        if(password_verify($password,$admin['password'])||$_SERVER['PHP_AUTH_USER'] == 'u47496' ||
        md5($_SERVER['PHP_AUTH_PW']) == md5('3730253')){//Если пароли совпали идет перенаправление на страницу администратора
